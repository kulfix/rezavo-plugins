...
**Core principle:** Fresh subagent per task + self-review = fast iteration.
...
digraph process {
    ...
    "Use rrz:finishing-a-development-branch → PR" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Run /pre-merge-review (3 audit rounds + fixes + approval)" -> "Use rrz:finishing-a-development-branch → PR";
}
```
...
[Use rrz:finishing-a-development-branch → PR]
...
- **rrz:finishing-a-development-branch** - Complete development after pre-merge-review → PR

**Subagents should use:**
- **rrz:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **rrz:executing-plans** - Use for parallel session instead of same-session execution
