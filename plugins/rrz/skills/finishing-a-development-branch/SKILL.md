...
Use project's test command from CLAUDE.md (e.g. `./cli.py test run`). If E2E relevant, also run E2E (`./cli.py e2e test smoke`). See `rrz:testing-guidelines` for details.
...
**If YES:** Run `rrz:visual-verification` skill. This will:
