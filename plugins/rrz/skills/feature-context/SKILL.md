...
Living document per feature. Other skills read it to understand scope — especially **rrz:audit** which uses `files:` to know what to review.
...
| Mistake | Fix |
|---------|-----|
| Not updating `files:` after tasks | rrz:audit falls back to full branch diff — noisy |
...
| Missing `plans:` link | rrz:audit (Javert) can't verify completeness |
...
**REQUIRED BY:** rrz:audit, rrz:brainstorming, rrz:writing-plans, rrz:executing-plans, rrz:finishing-a-development-branch
