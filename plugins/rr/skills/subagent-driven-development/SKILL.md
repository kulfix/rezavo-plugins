...
digraph process {
    ...
    "More tasks remain?" -> "Run /pre-merge-review (2 audit rounds + fixes)" [label="no"];
    "Run /pre-merge-review (2 audit rounds + fixes)" -> "Use rr:finishing-a-development-branch → PR";
}
```
...
[After all tasks]
[Run /pre-merge-review — 2 audit rounds with fixes]
