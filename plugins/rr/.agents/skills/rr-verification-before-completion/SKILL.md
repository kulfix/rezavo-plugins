---
name: rr-verification-before-completion
description: Codex port of rr:verification-before-completion workflow. Use when task matches the original rr skill intent.
---
